...
let new_msg = `"A person who never m a mistake never tried anything new"`;
...
let my_fav_numb = `"5"`;
let my_message = `My fav number is ${my_fav_numb}`;
...
let a = 5; // Zeeshan Tufail
let b = 89; // Date 14 July
console.log(a * b); // Multiplying two variable
//--------------------------------//
// Names: Store the names of a few of your friends in a array called names.
//  Print each person’s name by accessing each element in the list, one at a time.
let names_of_friends = ["Kashif", "Juniad", "Haroon"];
...
let fav_Vehical = ["Honda Vazel", "Toyta Vitz", " Kia sportage"];
...
// dinner.
let inivition = ["Khurram", "Faisal", "Faize", "Kashif", "Mirha"];
...
let Fav_place = ["Holand", "Ziarat", "Naran", "Muree"];
